...
<div class="container mt-4">
    ...
    <form action="{{ route('cerita.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea name="isi_cerita" id="editor" class="form-control" rows="10" required></textarea>
        </div>
        <div class="mb-3">
            <label class="form-label fw-bold">Gambar Cerita</label>
...
{{-- ✅ CKEditor 4 Full Build (fitur lengkap seperti Word) --}}

            ...
            @foreach($ceritas as $c)
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card shadow-sm border-orange h-100 hover-card">
                        @if($c->gambar)
                            <img src="{{ asset('storage/' . $c->gambar) }}" 
                                 class="card-img-top"
                                 alt="Gambar Cerita" 
                        ...
                        <div class="card-footer bg-light text-center">
                            <a href="{{ route('cerita.show', $c->id) }}" 
                               class="btn btn-outline-orange rounded-pill px-3">
                                📖 Lihat Detail
                            </a>
                        </div>
                    </div>
...
.btn-orange:hover {
    background-color: #f77f00; /* tetap oranye saat hover */
    color: #fff;
}
...
.btn-outline-orange:hover {
    background-color: transparent; /* tidak berubah warna */
    color: #f77f00;
    border-color: #f77f00;
}

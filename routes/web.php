...
Route::get('/pesanan/{id}/review', [ReviewController::class, 'reviewForm'])->name('pesanan.review');

// Menyimpan review dari form
...
Route::middleware(['auth', 'role:penjual'])->group(function () {
   ...
   Route::prefix('penjual')->middleware(['auth'])->group(function () {
    Route::get('/review', [PenjualReviewController::class, 'index'])->name('penjual.review.index');
    Route::get('review/{id}/balas', [PenjualReviewController::class, 'balasForm'])->name('penjual.review.balasForm');
    Route::post('review/{id}/balas', [PenjualReviewController::class, 'balasSubmit'])->name('penjual.review.balasSubmit');
});
